...
<?php
	while($row =pg_fetch_array($query)){
		...
		echo "<td><a href='form_edita.php?id=".$row['id_libro']."'>Editar</a></td>";
		echo "<td><a href='form_elimina.php?id=".$row['id_libro']."'>Eliminar</a></td>";
		echo "</tr>";
	}
?>	
	</tbody>
...
<?php
	echo "<a href='form_libros.php'> Nuevo libro</a></br>";
	}else{
