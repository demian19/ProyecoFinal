...
<html>
	<head>
		<meta charset="UTF-8">
		<title> Catálogo editorial </title>
...
<?php
	while($row =pg_fetch_array($query)){
		...
		echo "<td><a href='form_edita_editorial.php?id=".$row['id_editorial']."'>Editar</a></td>";
		echo "<td><a href='form_elimina_editorial.php?id=".$row['id_editorial']."'>Eliminar</a></td>";
		echo "</tr>";
	}
?>	
	</tbody>
...
<?php
	echo "<a href='form_editoriales.php'> Nueva editorial</a></br>";
	}else{
